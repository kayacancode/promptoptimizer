                ...
                <div className="border-2 border-black rounded-xl p-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-slate-900">{dashboardMetrics.availableTokens}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-2 border-black rounded-xl p-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-slate-900">{dashboardMetrics.optimizationCount}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-2 border-black  rounded-xl p-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-slate-900">{dashboardMetrics.successRate}%</p>
                    </div>
                  </div>
                </div>
              </div>
