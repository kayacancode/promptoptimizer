      ...
      <Tabs value={activeStep} onValueChange={setActiveStep}>
        ...
        <TabsContent value="configure">
          <Card className="p-4">
            ...
            <div className="mb-6">
              <h3 className="text-md font-semibold mb-2">Optimization Settings</h3>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    defaultValue={5}
                    onChange={(e) => {
                      // Update sample size for consistency testing
                    }}
                  />
                  <p className="text-sm text-gray-500 mt-1">Number of samples per model for consistency testing</p>
                </div>
                <div>
                  ...
                  <Input
                    ...
                    defaultValue={0.7}
                    onChange={(e) => {
                      // Update minimum acceptable score
                    }}
                  />
            ...
            <div className="space-y-4">
              <h3 className="text-md font-semibold">Model Configuration</h3>
                  ...
                  {config.enabled && (
                    <div className="space-y-2">
                      <div>
                        ...
                        />
                        <p className="text-sm text-gray-500 mt-1">Controls randomness in responses</p>
                      </div>
                      <div>
