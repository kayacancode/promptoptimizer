                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between pt-6 border-t">
                      ...
                      <Button 
                        ...
                        className="bg-black hover:from-blue-700 hover:to-purple-700 px-8 py-3 text-lg"
                      >
                        Continue
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between pt-6 border-t">
                      ...
                      <Button 
                        ...
                        className="bg-black hover:from-purple-700 hover:to-pink-700 px-8 py-3 text-lg"
                      >
                        Continue
                        <ArrowRight className="ml-2 h-5 w-5" />
                      </Button>
