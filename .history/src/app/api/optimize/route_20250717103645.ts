...
async function optimizePrompt(originalPrompt: string, requirements: string) {
  ...
  try {
    ...
    if (process.env.ANTHROPIC_API_KEY) {
      ...
      Here’s your refined, roleplay-driven evaluator agent prompt — structured for clarity, JSON-safe, and phrased as if it’s building optimized prompts specifically meant for other users to copy into their own LLM workflows:
      ...
      Let me know if you want help setting up token length validation or custom headers around this prompt.
